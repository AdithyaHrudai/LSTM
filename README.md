...
1. Clone this repository: `git clone https://github.com/AdithyaHrudai/LSTM/upload/main`
2. Run the `train.py` script to train the LSTM model.
3. Run the `predict.py` script to make predictions on new data.
...
- **Email:** hrudaiadithya2005@gmail.com
- **LinkedIn:** [Adithya Hrudai](https://www.linkedin.com/in/adithya-hrudai-17526a1aa/)
